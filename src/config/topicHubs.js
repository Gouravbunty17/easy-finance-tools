...
export const topicHubs = {
  tfsa: {
    ...
    audience: [
      { title: 'New contributors', body: 'Use the hub to understand room, withdrawals, and CRA record lag before making a first or catch-up TFSA contribution.' },
      { title: 'Flexible savers', body: 'A TFSA often helps when money may be needed before retirement, but the investment still has to match the timeline.' },
      { title: 'Investors comparing accounts', body: 'Use TFSA resources alongside RRSP and FHSA pages when a deduction or first-home goal may outrank flexibility.' },
      { title: 'People who recently withdrew', body: 'Withdrawal timing is one of the easiest ways to create an accidental excess contribution if same-year room is misunderstood.' },
    ],
    keyDecisions: [
      { title: 'How much room is actually available?', body: 'Start with CRA, then adjust for current-year deposits, withdrawals, transfers, and multiple TFSA accounts.' },
      { title: 'Is the money short-term or long-term?', body: 'Short timelines usually need safer holdings; long timelines may justify more growth risk inside the tax-free shelter.' },
      { title: 'Should TFSA beat RRSP or FHSA?', body: 'The answer changes with income, future tax assumptions, emergency savings, first-home eligibility, and liquidity needs.' },
    ...
    learningPath: [
      ...
      { title: '2. Check withdrawal timing', body: 'Understand why withdrawn amounts usually return as room next January, not immediately.' },
      { title: '3. Compare against RRSP and FHSA', body: 'Use decision framing before assuming the TFSA should get every new dollar.' },
      { title: '4. Avoid common TFSA mistakes', body: 'Review overcontribution, short-timeline, active-trading, and foreign-income pitfalls before investing.' },
    ],
    decisions: [
