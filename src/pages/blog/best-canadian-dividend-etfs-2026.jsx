...
const article = {
  ...
  sections: [
    {
      heading: "What counts as a Canadian dividend ETF?",
      paragraphs: [
    ...
    {
      heading: "Dividend ETF categories to compare in 2026",
      paragraphs: [
      ...
      table: {
        headers: ["ETF style", "What it is trying to do", "Main risk to check"],
        rows: [
    ...
    {
      heading: "Fees matter more than they look",
      paragraphs: [
    ...
    {
      heading: "Income is not the same as return",
      paragraphs: [
    ...
    {
      heading: "A simple screening checklist",
      paragraphs: [
  ...
  example: {
    title: "Example: estimating dividend ETF cash flow",
    paragraphs: [
  ...
  mistakes: [
    { title: "Chasing the highest yield", body: "A high distribution can come with concentration risk, option-strategy tradeoffs, falling prices, or payout changes. Yield alone is not enough." },
    { title: "Ignoring sector concentration", body: "Canadian dividend ETFs often lean toward financials, energy, utilities, telecom, and pipelines. That can be fine, but it is not the same as owning the whole market." },
    { title: "Forgetting fees", body: "Fees reduce investor returns every year. Higher-fee funds need a clear reason to be in the portfolio." },
    { title: "Confusing income with safety", body: "Dividend ETFs are still equity investments. They can fall in value and distributions can change." },
  ...
  related: [
    ...
    { type: "Tool", label: "Capital gains tax calculator", href: "/tools/capital-gains-tax", body: "Understand taxable-account capital gains context when selling ETF units." },
    { type: "Guide", label: "Best ETFs for TFSA Canada", href: "/blog/best-etfs-for-tfsa-canada-2026", body: "Compare dividend ETFs with growth and broad-market ETF categories for TFSA investors." },
    { type: "Guide", label: "How to start investing in Canada", href: "/blog/how-to-start-investing-canada-2026", body: "Use this beginner workflow if you are still choosing accounts and ETF basics." },
  ],
  methodology: {
    summary: "This guide uses an educational screening framework for Canadian-listed dividend ETFs. It avoids ranking products by live yield because yields, fees, holdings, and distributions change and must be verified on official provider fund pages.",
    assumptions: [
    ...
    sources: [
      { label: "CRA: TFSA contribution room", href: "https://www.canada.ca/en/revenue-agency/services/tax/individuals/topics/tax-free-savings-account/contributing/calculate-room.html" },
    ...
    note: "Educational information only. Confirm fund facts, fees, distribution history, holdings, account tax treatment, and suitability with official documents or a qualified professional.",
  },
  disclaimer: "This article is educational only and is not investment, tax, legal, or financial advice. Dividend ETF distributions are not guaranteed, ETF prices can fall, and no ETF mentioned here is a recommendation to buy or sell.",
  faqs: [
    { q: "Are Canadian dividend ETFs safe?", a: "They can be diversified, but they are still equity investments. Prices can fall, sectors can underperform, and distributions can change." },
    { q: "Is the highest-yield dividend ETF the best choice?", a: "Not automatically. A high yield can come with higher fees, concentration risk, covered-call tradeoffs, or weaker total return." },
    { q: "Should dividend ETFs go in a TFSA or RRSP?", a: "It depends on your income, goals, account room, and tax situation. A TFSA can make qualified withdrawals tax-free, while an RRSP can provide an upfront deduction and taxable withdrawals later." },
    { q: "What should I check before buying a dividend ETF?", a: "Review MER, holdings, sector weights, distribution history, yield, strategy, risk rating, fund size, and official fund facts." },
    { q: "Do covered-call ETFs pay more income?", a: "They may pay higher distributions, but the option strategy can limit upside and distributions can still vary. Understand the tradeoff before relying on the cash flow." },
    { q: "Can I live off dividend ETFs in Canada?", a: "Some investors use dividend ETFs for income, but the required portfolio size depends on spending, taxes, account type, yield assumptions, inflation, and market risk." },
  ],
};

export default function BestCanadianDividendETFs2026() {
