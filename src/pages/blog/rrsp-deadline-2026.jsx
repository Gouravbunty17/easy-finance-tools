  ...
  return (
    <div>
      ...
      <ArticleSchema
        ...
        url="https://easyfinancetools.com/blog/rrsp-deadline-canada-2026"
      ...
      <section className="mx-auto max-w-3xl px-4 py-12">
        ...
        <div className="mt-10 border-t pt-8 dark:border-gray-700">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <TrackedLink articleSlug="rrsp-deadline-2026" ctaLabel="related_tfsa_vs_rrsp" to="/blog/tfsa-vs-rrsp-canada-2026" className="block rounded-lg bg-white p-4 shadow transition hover:shadow-md dark:bg-gray-800">
