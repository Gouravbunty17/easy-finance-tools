      ...
      <section className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="mt-10 border-t pt-8 dark:border-gray-700">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <TrackedLink articleSlug="how-to-invest-in-canada-beginners-2026" ctaLabel="related_tfsa_vs_rrsp" to="/blog/tfsa-vs-rrsp-canada-2026" className="block rounded-lg bg-white p-4 shadow transition hover:shadow-md dark:bg-gray-800">
            ...
            <TrackedLink articleSlug="how-to-invest-in-canada-beginners-2026" ctaLabel="related_tfsa_room" to="/blog/tfsa-contribution-room-canada-2026" className="block rounded-lg bg-white p-4 shadow transition hover:shadow-md dark:bg-gray-800">
