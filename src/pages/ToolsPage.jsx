...
const tools = [
  ...
  { icon: "🇨🇦", title: "CPP & OAS Estimator", desc: "Estimate your government retirement income and find the best age to start collecting.", link: "/tools/cpp-oas-estimator", badge: "New!", color: "border-red-200 hover:border-red-400" },
