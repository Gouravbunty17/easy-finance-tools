      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-blue-200 text-sm">Free, private financial calculators for Canadians. No sign-up required.</p>
          </div>
          <div>
        ...
        <div className="border-t border-blue-800 pt-6 text-center text-blue-300 text-sm">
          <p>© {new Date().getFullYear()} EasyFinanceTools. All rights reserved. Not financial advice.</p>
          <p className="mt-1">Built with ❤️ in Canada 🇨🇦</p>
        </div>
      </div>
    </footer>
  );
