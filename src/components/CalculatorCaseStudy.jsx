...
export default function CalculatorCaseStudy({
  ...
  return (
    <section className="mt-10 rounded-3xl border border-emerald-200 bg-emerald-50 p-6 shadow-sm dark:border-emerald-900/60 dark:bg-emerald-950/20">
      ...
      {limitation ? (
        <p className="mt-5 rounded-2xl border border-emerald-200 bg-white p-4 text-sm leading-7 text-slate-600 dark:border-emerald-900/60 dark:bg-slate-900 dark:text-slate-300">
