...
export default function NextStepLinks({ title = 'What to do next', intro, links = [], trackingContext = 'next_step_links', className = '' }) {
  ...
  return (
    <section className={`rounded-3xl border border-slate-200 bg-slate-50 p-6 dark:border-slate-700 dark:bg-slate-900/60 ${className}`}>
      <p className="text-xs font-semibold uppercase tracking-[0.18em] text-secondary dark:text-emerald-300">Next step links</p>
